...
SCRIPT_DIR="/isilon/sequencing/Kurt/GIT_REPO/GSP_WGS/scripts"
...
BWA_DIR="/isilon/sequencing/Kurt/Programs/BWA/bwa-0.7.15"
PICARD_DIR="/isilon/sequencing/Kurt/Programs/Picard/picard-2.8.3"
...
CONTROL_GVCF_LIST="/isilon/sequencing/Kurt/GIT_REPO/JHGenomics_CGC_Clinical_Exome/data/Control_GVCF.list"
...
CREATE_SAMPLE_INFO_ARRAY ()
{
SAMPLE_INFO_ARRAY=(`awk '$8=="'$SAMPLE'" {print $1,$8}' ~/CGC_PIPELINE_TEMP/SORTED.$MANIFEST_PREFIX.txt`)
}
...
MAKE_PROJ_DIR_TREE ()
{
mkdir -p $CORE_PATH/${SAMPLE_INFO_ARRAY[0]}/LOGS \
$CORE_PATH/${SAMPLE_INFO_ARRAY[0]}/BAM \
...
$CORE_PATH/${SAMPLE_INFO_ARRAY[0]}/{LOGS,VCF,RELATEDNESS,PCA} \
...
# | uniq \
# | awk '{split($3,smtag,"[@-]"); \
# print "qsub","-N","B.01_MARK_DUPLICATES_"$3"_"$1,\
# "-hold_jid","A.01_BWA_"$8"_"$2"_"$3"_"$4,\
# "-o","'$CORE_PATH'/"$1"/"$2"/"$3"/LOGS/"$8"_"$2"_"$3"_"$4".MARK_DUPLICATES.log",\
...
# | awk 'BEGIN {FS="\t"} \
# gsub(/,/,",C.01_FIX_SORT_AGGRO"$3"_",$4) \
...
# "'$SCRIPT_DIR'""/C.01_FIX_SORT_AGGRO.sh",\
...
# $JAVA_1_8 $GATK_DIR $CORE_PATH \
# ${FAMILY_INFO_ARRAY[0]} ${FAMILY_INFO_ARRAY[2]} ${FAMILY_INFO_ARRAY[3]} ${FAMILY_INFO_ARRAY[4]} $CHROM $CONTROL_GVCF_LIST
# echo sleep 1s
# done
# }
# 
...
# "'$JAVA_1_8'","'$GATK_DIR'","'$CORE_PATH'",$1,$2,$3,"'$HAPMAP'","'$OMNI_1KG'","'$HI_CONF_1KG_PHASE1_SNP'","'$DBSNP_129'""\n""sleep 1s"}'
# 
...
# echo \
# qsub \
# -N T.06-2_VARIANT_TO_TABLE_SAMPLE_ALL_SITES_${SAMPLE_INFO_ARRAY_2[1]}_${SAMPLE_INFO_ARRAY_2[0]}_$CHROMOSOME \
# -hold_jid P.01-A.04_FILTER_TO_SAMPLE_ALL_SITES_${SAMPLE_INFO_ARRAY_2[1]}_${SAMPLE_INFO_ARRAY_2[0]}_$CHROMOSOME \
...
# | sort -k 1,1 -k 2,2 -k 3,3 \
# | uniq \
# | awk '{print "qsub","-N","T.06-2-A.01-A.01_VARIANT_TO_TABLE_BGZIP_SAMPLE_ALL_SITES_"$3"_"$2"_"$1,\
...
# | sort -k 1,1 -k 2,2 -k 3,3 \
# | uniq \
# | awk '{print "qsub","-N","T.06-2-A.01-A.01-A.01_VARIANT_TO_TABLE_TABIX_SAMPLE_ALL_SITES_"$3"_"$2"_"$1,\
# "-hold_jid","T.06-2-A.01-A.01_VARIANT_TO_TABLE_BGZIP_SAMPLE_ALL_SITES_"$3"_"$2"_"$1,\
