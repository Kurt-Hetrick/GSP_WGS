...
$JAVA_1_8/java -jar -Xmx48g $PICARD_DIR/picard.jar MarkDuplicates \
$INPUT \
OUTPUT=$CORE_PATH/$PROJECT/TEMP/$SM_TAG".dup.bam" \
VALIDATION_STRINGENCY=SILENT \
METRICS_FILE=$CORE_PATH/$PROJECT/REPORTS/ESTIMATE_LIBRARY/$SM_TAG"_MARK_DUPLICATES.txt" \
CREATE_INDEX=true \
ASSUME_SORT_ORDER=queryname \
OPTICAL_DUPLICATE_PIXEL_DISTANCE=${MODEL}
